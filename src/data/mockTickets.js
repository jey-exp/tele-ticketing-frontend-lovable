...
export const mockTickets = [
  ...
  {
    id: 'TKT-NOC-001',
    title: 'Core network switch reporting high latency',
    customer: { id: 'CUST003', name: 'Mega Enterprises' },
    status: TICKET_STATUS.IN_PROGRESS,
    priority: PRIORITY.HIGH,
    severity: SEVERITY.CRITICAL,
    category: 'Network Performance',
    subCategory: 'Latency',
    description: 'The primary core switch is showing latency spikes every 15 minutes. Need to investigate routing tables and hardware diagnostics.',
    attachments: [],
    ...
    assignedTo: [{ id: 'ENG002', name: 'Bob Smith' }],
    logs: [
      { timestamp: '2025-10-26T11:35:00Z', update: 'Ticket assigned to NOC Engineer Ben Carter.' },
    ],
  },
  {
    id: 'TKT-L1-001',
    title: 'Customer cannot access internal VPN',
    customer: { id: 'CUST004', name: 'Innovate LLC' },
    status: TICKET_STATUS.PENDING,
    priority: PRIORITY.MEDIUM,
    severity: SEVERITY.MAJOR,
    category: 'Connectivity Issue',
    subCategory: 'VPN',
    description: 'User reports their VPN client fails to connect with error code 789. Initial password reset did not solve the issue.',
    attachments: [],
    ...
    assignedTo: [{ id: 'ENG001', name: 'Alice Johnson' }],
    logs: [
      { timestamp: '2025-10-26T10:10:00Z', update: 'Ticket assigned to L1 Engineer Chloe Davis.' },
    ],
  },
];
