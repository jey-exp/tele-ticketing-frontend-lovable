...
const PendingTickets = () => {
    ...
    // Handles clicking a ticket card to open the modal.
                                    ...
                                    <div className="space-y-4 border-t pt-4">
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <Select value={editedPriority} onValueChange={setEditedPriority}><SelectTrigger><SelectValue /></SelectTrigger>
                                                    <SelectContent>
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <Select value={editedSeverity} onValueChange={setEditedSeverity}><SelectTrigger><SelectValue /></SelectTrigger>
                                                    <SelectContent>
                                                        ...
                                                        <CommandList><CommandEmpty>No engineers found.</CommandEmpty>
                                                            <CommandGroup>
                                                                {assignableEngineers.map((engineer) => (
                                                                    <CommandItem key={engineer.id} value={engineer.fullName} onSelect={() => setSelectedEngineerIds(prev => prev.includes(engineer.id) ? prev.filter(id => id !== engineer.id) : [...prev, engineer.id])}>
